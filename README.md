...
<table>
    ...
    <tr>
        <th>License</th>
        <td>Arachni Public Source License v1.0 - (see <a href="https://github.com/redhawkeye/arachni/blob/master/LICENSE.md">LICENSE</a> file)</td>
    </tr>
</table>
...
Arachni Public Source License v1.0 -- please see the [LICENSE](LICENSE.md) file for more information.
